            ...
            {activeOrders.map(order => (
              <div key={order.orderId} style={{
                ...
                {order.orderStatus === 'READY' && (
                  <div>
                    <div style={styles.readyAlert}>✅ Ready to serve!</div>
...
const styles = {
  ...
  customerInfo: {
    fontSize: '13px', color: '#3498db', marginBottom: '8px',
    fontWeight: '600',
  },
  readyAlert: {
  ...
  dispatchBtn: {
    ...
    cursor: 'pointer', fontWeight: '600', fontSize: '13px', marginTop: '8px',
  },
  billBtn: {
  ...
  label: { fontSize: '14px', fontWeight: '600', color: '#333', minWidth: '130px' },
  select: {
